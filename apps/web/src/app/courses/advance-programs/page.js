...
export const metadata = {
  title: "Advance Programs | VieBrain",
  description: "Browse our catalog of advanced mind training programs.",
};
...
export default function AdvanceProgramsPage() {
  return (
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight drop-shadow-sm">
              Advance <span className="text-orange-500">Programs</span>
            </h1>
            <p className="text-lg text-slate-600 font-medium leading-relaxed">
              Browse our premium collection of advanced mind training courses. 
